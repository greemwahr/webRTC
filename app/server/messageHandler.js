...
function onInit(ws, id) {
  ...
  // console.log('connectedPeers[id]:', connectedPeers[id]);

  // Getting list of all clients connected to signaling server and connection details
  clients.push(connectedPeers[id]);
